<template lang="html">
  <div class="">
    <div v-if="!newview && !viewupdate">
      <p><samp class="txtblack">Frecuencia:</samp> Toda vez que se genere una orden de traspaso.<br>
      ...
      <p class="leyenda"> HISTORICO DE ORDENES DE TRASPASO DE PRODUCTO CALIBRADO / TERMINADO </p>
      <hr>
   </div>

    <transfersbins v-if="newview" v-on:getcloseshower="closes()" :shower="item"></transfersbins>
      ...
      <div  class="row">
         ...
         <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
             ...
             <div class="input-group">
              <input type="text" class="form-control input-sm"  placeholder="buscar una orden">
            ...
            <div class="panel panel-default pnl">
                <div class="panel-heading pnl-heading-fix-t">
                    <div class="row rowheader">
                      ...
                      <div class="col-lg-1 hidden-md  col-sm-2 hidden-xs">Tipo</div>
                      <div class="col-lg-2 hidden-md  col-sm-2 hidden-xs">Cliente </div>
                      <div class="col-lg-2 hidden-md  col-sm-2 hidden-xs">Destino </div>
                      <div class="col-lg-1 col-md-1 col-sm-1 hidden-xs">Cantidad </div>
              ...
              <div class="panel-body pnl-body-fix-t">
                <div class="row rowset" v-for="entity in list" :key="entity.id" :class="{closes: entity.status_id === 2}">
                  ...
                  <div class="col-lg-1 col-md-2 col-sm-2 hidden-xs">{{getdescrip(entity.type_id, 'types')}} </div>
                  <div class="col-lg-2 hidden-md  col-sm-2 hidden-xs">{{getdescrip(entity.initial_client_id, 'clients')}}</div>
                  <div class="col-lg-2 hidden-md  col-sm-2 hidden-xs">{{getdescrip(entity.end_client_id, 'clients')}}</div>
                  <div class="col-lg-1 hidden-md  hidden-sm hidden-xs">{{entity.cant}}</div>
                  ...
                  <div v-if="entity.status_id === 1" class="col-lg-1 col-md-1 col-sm-2 col-xs-6">
                    <div class="dropdown ">
                      ...
                      <ul class="dropdown-menu dropdown-fix" aria-labelledby="dropdownMenu1">
                        ...
                        <li v-if="entity.status_id === 1 && entity.sendto !== 10"><a @click="info(entity)">Informe</a></li>
...
import transfersbins from '@/components/transfersbins'
...
export default {
  ...
  data () {
    return {
      entity: '',
      status: [{id: 1, name: 'Procesando'}, {id: 2, name: 'Aplicado'}],
      types: [{id: 1, name: 'Calibrados'}, {id: 2, name: 'Terminado'}],
      title: '',
      itemkill: {},
      list: [],
      listcalibers: [],
  ...
  components: {
    datepicker, paginator, easpinner, deletes, transfersbins
  },
  mounted () {
    this.getlist()
  },
  methods: {
    ...
    info (aitem) {
      this.item = JSON.parse(JSON.stringify(aitem))
      window.$('#printframe').html('<iframe src="' + urlapi + '/transfers/info/' + aitem.id + '"height="100%" width="100%" frameborder="0"></iframe>')
