<template lang="html">
   <div class="">
     <div v-if="!newview">
       ...
       <p class="text-justify"><samp class="txtblack">AYUDA:</samp> Modulo despachar de producto terminado, utilize el boton "Nuevo".<br>
       <p class="leyenda"> HISTORICO DESPACHOS</p>
        <hr>
     </div>
            ...
            <div class="panel panel-default pnl">
                <div class="panel-heading pnl-heading-fix-t">
                    <div class="row rowheader">
                      ...
                      <div class="col-lg-2 hidden-md hidden-sm col-xs-6">Folio</div>
              ...
              <div class="panel-body pnl-body-fix-t">
                <div class="row rowset" v-for="entity in list" :key="entity.id" :class="{recep: entity.status === 2 && entity.type_id === 1, recep1: entity.status === 2 && entity.type_id === 2}">
